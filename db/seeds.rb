...
krypton = Article.create! name: "Krypton", author: clark, published_at: 9.weeks.ago, content: <<-ARTICLE
...
Comment.create! article: superman, content: <<-COMMENT
I want to meet Superman again, does anyone know where I can find him?
COMMENT

Comment.create! article: batman, content: <<-COMMENT
...
Comment.create! article: batman, content: <<-CONTENT
